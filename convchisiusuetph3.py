...
fileout  = 'chisiusuet_500000_ph3.txt'
filedup  = 'chisiusuet_500000_ph3dup.txt'
...
#          val = str(100001 + cntout3)
          val = str(cntout3+1).zfill(6)
          freq = line[4:] 
          lineout = val + ' ' +key1 + ' ' + freq
          fo.write(lineout)
#          fo.write(lineout+'\n')
          if cntout3 == 0:
             print('**convering chisiusuetph3...')
          cntout3 += 1
