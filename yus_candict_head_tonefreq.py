import codecs
import os
print('**yus_candict_head_tonefreq.py - add tonefreq to yus_candict_head.txt')
filepath = 'yus_candict_head.txt'  
#cheung 張
fileout  = 'yus_candict_head_freq.txt'
#cheung 19999張
...
'''
filepath = 'yus_candict_head_freq.txt' 
fileout  = 'yus_candict_head_freqsort.txt'
if os.path.exists(fileout):
    os.remove(fileout)
fo = open(fileout,'a+', encoding='utf-16') 
#linein = 'kug9999功' 
...
#--------------------------------------------
filepath = 'yus_candict_head_freq.txt' 
fileout  = 'yus_candict_head_tonefreq.txt'
if os.path.exists(fileout):
    os.remove(fileout)
fo = open(fileout,'a+', encoding='utf-16') 
#linein = 'cheung9999張' 
...
#---------------------------------------
'''
now yus_candict_head_tongfreq,txt :-   key(column 1-6)  tone(8) freq(10-13) ch(15-16)
1234567890123456
ah     3 0542 亞
ah     3 0675 阿
ah     1 0800 啊
...
'''
# Read the input file
input_file = 'yus_candict_head_tonefreq.txt'
...
output_file = 'yus_candict_head_tonefreqsort.txt'
...
filepath = 'yus_candict_head_tonegroupsort.txt'
fileout  = 'yus_candict_head_tonefinal.txt'
if os.path.exists(fileout):
    os.remove(fileout)
fo = open(fileout,'a+', encoding='utf-16') 
#linein = 'kug9999功' 
