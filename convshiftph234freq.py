import codecs
import os
# remove middle 10 columns freq after sort by ultraedit
filepath = 'reneeyu_ph234outfreq2.txt'  
fileout  = 'reneeyu_ph234out.txt'
if os.path.exists(fileout):
    os.remove(fileout)
fo = open(fileout,'a+', encoding='utf-16') 
#linein = 'kungfu 9999988888功夫' 
lineout = 'kungfu 功夫' 
