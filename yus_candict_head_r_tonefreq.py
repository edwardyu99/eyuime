import codecs
import os
print('**yus_candict_head_r_tonefreq.py - add tonefreq to yus_candict_head_r.txt')
filepath = 'yus_candict_head_r.txt'  
#cheung 張
fileout  = 'yus_candict_head_r_freq.txt'
#cheung 19999張
...
'''
filepath = 'yus_candict_head_r_freq.txt' 
fileout  = 'yus_candict_head_r_freqsort.txt'
if os.path.exists(fileout):
    os.remove(fileout)
fo = open(fileout,'a+', encoding='utf-16') 
#linein = 'kug9999功' 
...
#--------------------------------------------
filepath = 'yus_candict_head_r_freq.txt' 
fileout  = 'yus_candict_head_r_tonefreq.txt'
if os.path.exists(fileout):
    os.remove(fileout)
fo = open(fileout,'a+', encoding='utf-16') 
#linein = 'cheung9999張' 
...
#---------------------------------------
'''
now yus_candict_head_r_tongfreq,txt :-   key(column 1-6)  tone(8) freq(10-13) ch(15-16)
1234567890123456
ah     3 0542 亞
ah     3 0675 阿
ah     1 0800 啊
...
'''
# Read the input file
input_file = 'yus_candict_head_r_tonefreq.txt'
...
output_file = 'yus_candict_head_r_tonefreqsort.txt'
...
# Read the input file
input_file = 'yus_candict_head_r_tonefreqsort.txt'
output_file = 'yus_candict_head_r_tonegroup.txt'
...
'''
# Read the input file
input_file = 'yus_candict_head_r_tonegroup.txt'

# Sort the lines
sorted_lines = sorted(open(input_file, 'r', encoding='utf-16'), key=lambda x: (x[0:6], x[17:19])) # x[17:20]))

# Write the sorted lines to a new file
output_file = 'yus_candict_head_r_tonegroupsort.txt'
with open(output_file, 'w', encoding='utf-16') as f:
    f.writelines(sorted_lines)
...
filepath = 'yus_candict_head_r_tonegroupsort.txt'
fileout  = 'yus_candict_head_r_tonefinal.txt'
if os.path.exists(fileout):
    os.remove(fileout)
fo = open(fileout,'a+', encoding='utf-16') 
#linein = 'kug9999功' 
