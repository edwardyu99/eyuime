...
#filepath = 'reneeyu_canph234chissdup.txt' 
fileout  = 'reneeyu_canph234baiduout.txt'
filedup  = 'reneeyu_canph234baidudup.txt'
...
## ignore ph2 not found in mydict
             ...
             cnt += 1
             continue
## ignore ph2 not found in mydictbaidu AND not in mydcitchiss, out dup
          keydict = key1 + key2
          valdict = mydictbaidu.get(keydict,'000000')
          if valdict == '000000':
            valdict = mydictchiss.get(keydict,'000000') 
            if valdict == '000000':  
             fd.write(line)
             cntdup2 += 1
